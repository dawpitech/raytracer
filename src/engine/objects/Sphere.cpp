...
raytracer::engine::objects::Sphere::Sphere(const math::Point3D& center, const double radius)
...
bool raytracer::engine::objects::Sphere::hit(const Ray& ray, const math::Interval& ray_t, HitRecord& record) const
{
